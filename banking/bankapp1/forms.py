...
# from bankapp1.models import Banking,Branch
#
...
#             'cheque book':forms.Select(attrs={'class':'form-control'}),
#             'passbook'  :forms.Select(attrs={'class':'form-control'}),
#             'netbanking':forms.Select(attrs={'class':'form-control'}),
#
#                      }
#
#
